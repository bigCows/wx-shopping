...
export declare type Method = 'get' | 'GET' | 'delete' | 'DELETE' | 'head' | 'HEAD' | 'options' | 'OPTIONS' | 'post' | 'POST' | 'put' | 'PUT' | 'connect' | 'CONNECT' | 'trace' | 'TRACE';
export declare type ResponseType = 'arraybuffer' | 'text';
export declare type DataType = 'json';
